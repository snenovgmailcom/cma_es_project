# CEC2014, D=30, B=300K — MSC-CMA-ES vs CMAES-NBC-qN
...
Nguyen reports 51 runs per function and `maxFEs = 10,000 × D`; therefore D=30 corresponds to **300,000 NFE**. CMAES-NBC-qN mean/std values below are taken from **Table 10**.
...
| f2 | unimodal and simple multimodal | 6.629e-08 | **0** | 3.485e-07 | 0 |
| f3 | unimodal and simple multimodal | 5.948e-05 | **0** | 8.214e-05 | 0 |
...
| f15 | unimodal and simple multimodal | **3.1239** | 1.230e+06 | 0.640533 | 8.780e+06 |
...
| f21 | Hybrid | **648.563** | 4.060e+04 | 134.485 | 2.280e+05 |
| f22 | Hybrid | **27.7286** | 134 | 6.45616 | 51.8 |
| f23 | Composition | **315.244** | 1020 | 7.999e-14 | 2250 |
