...
|:--|--:|--:|--:|--:|--:|--:|
| **f1** | **1.0098e-05 · `>`** | **1.3464e-05 · `>`** | **1.0098e-05 · `>`** | **0.00360837 · `>`** | 0.498203 · `=` | **1.0098e-05 · `>`** |
| **f2** | **3.25269e-07 · `<`** | 0.224822 · `=` | 0.878128 · `=` | 0.666609 · `=` | **8.72815e-09 · `>`** | **0.000239119 · `<`** |
| **f3** | 0.12694 · `=` | **2.12934e-13 · `<`** | **2.25803e-14 · `<`** | **9.48604e-05 · `<`** | **0.0096767 · `<`** | **3.34095e-17 · `<`** |
| **f4** | **3.5845e-15 · `>`** | **3.50432e-17 · `>`** | **9.36092e-10 · `>`** | **5.19011e-19 · `>`** | **3.216e-17 · `>`** | **2.5958e-17 · `>`** |
| **f5** | **1.52914e-08 · `>`** | **7.46709e-11 · `>`** | 0.878128 · `=` | 0.114628 · `=` | 0.498203 · `=` | 0.124506 · `=` |
| **f6** | **2.40441e-09 · `>`** | **3.59172e-16 · `>`** | **1.26302e-11 · `>`** | **2.97331e-17 · `>`** | **5.54558e-11 · `>`** | **3.10406e-17 · `>`** |
| **f7** | **5.26103e-12 · `>`** | **3.99093e-17 · `>`** | **3.18758e-08 · `>`** | **2.97331e-17 · `>`** | **3.99093e-17 · `>`** | **3.10406e-17 · `>`** |
| **f8** | **0.00691018 · `<`** | **0.000259012 · `<`** | **2.29083e-13 · `<`** | 0.666609 · `=` | 0.498203 · `=` | **1.37029e-19 · `<`** |
| **f9** | **3.00562e-07 · `<`** | **0.00341027 · `<`** | **1.38738e-16 · `<`** | 0.129715 · `=` | **1.77278e-05 · `<`** | **9.27906e-13 · `<`** |
| **f10** | **7.80182e-15 · `<`** | **4.48597e-08 · `>`** | **2.68584e-17 · `<`** | **6.12894e-17 · `<`** | **6.32388e-16 · `<`** | **6.42122e-18 · `<`** |
| $n_{<}/n_{>}/n_{=}$ | 4/5/1 | 3/6/1 | 4/4/2 | 2/4/4 | 3/4/3 | 5/4/1 |
...
| Function | BIPOP-CMA-ES | ARRDE | L-SRTDE | NL-SHADE-RSP | j2020 | jSO |
|:--|--:|--:|--:|--:|--:|--:|
| **f8** | **0.00345509 · `<`** | **0.000172675 · `<`** | **3.27262e-14 · `<`** | 0.607591 · `=` | 0.231041 · `=` | **4.11087e-20 · `<`** |
| **f9** | **1.20225e-07 · `<`** | **0.00170514 · `<`** | **3.08307e-17 · `<`** | 0.086477 · `=` | **7.09111e-06 · `<`** | **2.31977e-13 · `<`** |
| **f10** | **2.60061e-15 · `<`** | **2.69158e-08 · `>`** | **8.05753e-18 · `<`** | **2.62669e-17 · `<`** | **2.37145e-16 · `<`** | **1.42694e-18 · `<`** |
| $n_{<}/n_{>}/n_{=}$ | 3/0/0 | 2/1/0 | 3/0/0 | 1/0/2 | 2/0/1 | 3/0/0 |
...
| **f2** | **1.74028e-14 · `<`** | **0.0202936 · `>`** | **3.95945e-07 · `<`** | 0.941886 · `=` | **1.21537e-19 · `>`** | **4.59671e-08 · `<`** |
| **f3** | **0.00199204 · `<`** | 0.927038 · `=` | **2.87623e-17 · `<`** | 0.0601711 · `=` | **1.25047e-19 · `>`** | **2.00892e-17 · `<`** |
| **f4** | **3.86118e-17 · `>`** | **2.93806e-17 · `>`** | **0.000753808 · `>`** | **1.39059e-19 · `>`** | **8.51037e-18 · `>`** | **2.00892e-17 · `>`** |
| **f5** | **0.0261667 · `<`** | **1.4549e-07 · `>`** | **4.42514e-10 · `<`** | **6.63892e-05 · `>`** | **6.38987e-07 · `>`** | **3.94728e-05 · `>`** |
| **f6** | **6.56013e-08 · `>`** | **2.93806e-17 · `>`** | **0.00020567 · `>`** | **2.64295e-17 · `>`** | **3.34166e-17 · `>`** | **2.00892e-17 · `>`** |
| **f7** | **2.5899e-06 · `>`** | **2.93806e-17 · `>`** | 0.499345 · `=` | **2.64295e-17 · `>`** | **1.98221e-17 · `>`** | **2.11525e-17 · `>`** |
| **f8** | 0.462714 · `=` | **5.48887e-18 · `>`** | **1.19079e-14 · `<`** | **3.18244e-08 · `>`** | **9.01618e-19 · `>`** | **1.35871e-19 · `<`** |
| **f9** | **1.43731e-13 · `<`** | **3.9807e-15 · `>`** | **2.87623e-17 · `<`** | **0.000236339 · `<`** | **2.221e-08 · `<`** | **7.64477e-18 · `<`** |
| **f10** | **2.91285e-17 · `<`** | **1.60597e-15 · `<`** | **2.67938e-17 · `<`** | **4.20495e-19 · `<`** | **8.52717e-17 · `<`** | **5.65434e-18 · `<`** |
| $n_{<}/n_{>}/n_{=}$ | 5/3/2 | 1/7/2 | 6/2/2 | 2/5/3 | 2/7/1 | 5/4/1 |
...
| Function | BIPOP-CMA-ES | ARRDE | L-SRTDE | NL-SHADE-RSP | j2020 | jSO |
|:--|--:|--:|--:|--:|--:|--:|
| **f8** | 0.231357 · `=` | **1.64666e-18 · `>`** | **1.70113e-15 · `<`** | **1.06081e-08 · `>`** | **3.38107e-19 · `>`** | **4.07613e-20 · `<`** |
| **f9** | **4.1066e-14 · `<`** | **7.96141e-16 · `>`** | **8.03813e-18 · `<`** | **5.90847e-05 · `<`** | **7.40332e-09 · `<`** | **1.25652e-18 · `<`** |
| **f10** | **8.73855e-18 · `<`** | **5.35323e-16 · `<`** | **8.03813e-18 · `<`** | **1.40165e-19 · `<`** | **4.26359e-17 · `<`** | **1.25652e-18 · `<`** |
| $n_{<}/n_{>}/n_{=}$ | 2/0/1 | 1/2/0 | 3/0/0 | 2/1/0 | 2/1/0 | 3/0/0 |
