...
Sums of per-function metrics, grouped by function class. Categories: **Basic** = F1–F5 (1 unimodal + 4 basic multimodal), **Hybrid** = F6–F8, **Composition** = F9–F12. Total: 12 functions. Budget: 200,000 evaluations (2 × 10⁵).
...
| | median | 3.74e-3 | 3.80e-5 |   | 0.995 | **0** | 11.0 | 5.97 | 1.99 |
