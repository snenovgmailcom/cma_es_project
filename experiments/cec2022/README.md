...
Official budgets — D=10: 2×10^5, D=20: 10^6.

## Ranking — D=10

Parallel-coordinate rank on four aggregate metrics (Maximum-SUM, Median-SUM, FBTC(B), Minimum-SUM). The axes are oriented so smaller error-based sums and larger FBTC(B) values appear toward the top. MSC-CMA-ES is shown in red. Budget: 2×10^5 evaluations.
...
|:--|:--:|--:|--:|--:|--:|--:|--:|--:|
| Unimodal and simple multimodal | 10 | 0.00372 | 3.8e-5 | 0.995 | **0** | 11 | 5.97 | 1.99 |
| Unimodal and simple multimodal | 20 | **1.11** | 1.99 | 2.98 | 45.9 | 94.6 | 22.9 | 51.9 |
...
| Category | Dim | MSC-CMA-ES | BIPOP-CMA-ES | ARRDE | L-SRTDE | NL-SHADE-RSP | j2020 | jSO |
|:--|:--:|--:|--:|--:|--:|--:|--:|--:|
| Unimodal and simple multimodal | 10 | 7.7e-5 | **0** | **0** | **0** | 5.97 | 2.01 | 0.995 |
| Unimodal and simple multimodal | 20 | 3.4e-4 | **0** | 0.995 | 44.9 | 29.8 | 7.24 | 46.9 |
...
| Category | Dim | MSC-CMA-ES | BIPOP-CMA-ES | ARRDE | L-SRTDE | NL-SHADE-RSP | j2020 | jSO |
|:--|:--:|--:|--:|--:|--:|--:|--:|--:|
| Unimodal and simple multimodal | 10 | 7.11 | 5.98 | **2.98** | 10.9 | 18.9 | 14.1 | 7.97 |
| Unimodal and simple multimodal | 20 | 33.1 | 48.9 | **9.01** | 52.1 | 237 | 74.5 | 57 |
...
| Category | Dim | MSC-CMA-ES | BIPOP-CMA-ES | ARRDE | L-SRTDE | NL-SHADE-RSP | j2020 | jSO |
|:--|:--:|--:|--:|--:|--:|--:|--:|--:|
| Unimodal and simple multimodal | 10 | 4.043 | 4.259 | 4.300 | **4.546** | 4.092 | 3.790 | 4.122 |
| Unimodal and simple multimodal | 20 | 3.264 | 3.865 | **4.141** | 3.506 | 3.000 | 3.228 | 3.167 |
