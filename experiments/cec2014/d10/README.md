...
|:--|:--|--:|--:|:-:|--:|--:|--:|--:|--:|
| **Basic** (n=16) | mean | 98.9 | 133 |    | 132 | **52.7** | 138 | 118 | 83.6 |
...
*Generated 2026-06-28 by analysis/cell_report.py from `*/maxevals_100000/f*.pkl` (table) and all common budgets (budget scaling).*
