...
*USM = unimodal and simple multimodal, per the CEC2014 definition.*
...
*Generated 2026-07-14 by analysis/cell_report.py from `*/maxevals_100000/f*.pkl` (table) and all common budgets (budget scaling).*
