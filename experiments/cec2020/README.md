...
Parallel-coordinate rank on four aggregate metrics (Maximum-SUM, Median-SUM, FBTC(B), Minimum-SUM). The axes are oriented so smaller error-based sums and larger FBTC(B) values appear toward the top. MSC-CMA-ES is shown in red. Budget: 5×10^4 evaluations.
...
Parallel-coordinate rank on four aggregate metrics (Maximum-SUM, Median-SUM, FBTC(B), Minimum-SUM). The axes are oriented so smaller error-based sums and larger FBTC(B) values appear toward the top. MSC-CMA-ES is shown in red. Budget: 10^6 evaluations.
...
## Ranking — D=10 (budget 2×10^7)

Same rank, recomputed at 2×10^7 evaluations. Only classes with full 7-algorithm coverage at 2×10^7 are shown.
...
Parallel-coordinate rank on four aggregate metrics (Maximum-SUM, Median-SUM, FBTC(B), Minimum-SUM). The axes are oriented so smaller error-based sums and larger FBTC(B) values appear toward the top. MSC-CMA-ES is shown in red. Budget: 3×10^6 evaluations.
...
Parallel-coordinate rank on four aggregate metrics (Maximum-SUM, Median-SUM, FBTC(B), Minimum-SUM). The axes are oriented so smaller error-based sums and larger FBTC(B) values appear toward the top. MSC-CMA-ES is shown in red. Budget: 10^7 evaluations.
...
## Ranking — D=20 (budget 4×10^7)

Same rank, recomputed at 4×10^7 evaluations. Only classes with full 7-algorithm coverage at 4×10^7 are shown.
