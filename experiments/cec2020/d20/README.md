...
## Ranking across metrics (budget 10^7)
...
## Ranking across metrics (budget 4×10^7)

Same parallel-coordinate rank, recomputed at 4×10^7 evaluations. Only classes with full 7-algorithm coverage at 4×10^7 are shown. MSC-CMA-ES is shown in red.
