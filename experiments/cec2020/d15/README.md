...
## Ranking across metrics (budget 3×10^6)
...
Same parallel-coordinate rank, recomputed at 10^7 evaluations. Only classes with full 7-algorithm coverage at 10^7 are shown. MSC-CMA-ES is shown in red.
