...
## Ranking across metrics (budget 2×10^7)

Same parallel-coordinate rank, recomputed at 2×10^7 evaluations. Only classes with full 7-algorithm coverage at 2×10^7 are shown. MSC-CMA-ES is shown in red.
